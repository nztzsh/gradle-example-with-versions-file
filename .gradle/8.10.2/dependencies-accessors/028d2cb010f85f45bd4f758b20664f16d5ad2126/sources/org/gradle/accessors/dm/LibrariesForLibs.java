...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     * with version reference <b>commons.text</b>
     * <p>
    ...
    /**
     * Dependency provider for <b>jacksonDatabind</b> with <b>com.fasterxml.jackson.core:jackson-databind</b> coordinates and
    ...
    /**
     * Dependency provider for <b>springBootStarter</b> with <b>org.springframework.boot:spring-boot-starter</b> coordinates and
     * with version reference <b>springBoot</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getSpringBootStarter() {
        return create("springBootStarter");
    }

    /**
     * Dependency provider for <b>springBootStarterWeb</b> with <b>org.springframework.boot:spring-boot-starter-web</b> coordinates and
     * with version reference <b>springBoot</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getSpringBootStarterWeb() {
        return create("springBootStarterWeb");
    }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>dependencyManagement</b> with value <b>1.1.0</b>
         * <p>
        ...
        /**
         * Version alias <b>springBoot</b> with value <b>3.1.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class CommonsVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>commons.text</b> with value <b>1.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getText() { return getVersion("commons.text"); }
    ...
    public static class JacksonVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>jackson.databind</b> with value <b>2.9.10.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class Log4jVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>log4j.core</b> with value <b>2.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
